...
REM
REM Generated by Vivado on Fri Mar 10 15:31:39 -0800 2023
...
call xsim  Johnson_Counter_tb_behav -key {Behavioral:sim_1:Functional:Johnson_Counter_tb} -tclbatch Johnson_Counter_tb.tcl -log simulate.log
