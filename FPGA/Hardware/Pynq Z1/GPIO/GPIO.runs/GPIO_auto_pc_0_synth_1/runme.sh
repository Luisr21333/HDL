...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Pynq Z1/GPIO/GPIO/GPIO.runs/GPIO_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPIO_auto_pc_0.tcl
