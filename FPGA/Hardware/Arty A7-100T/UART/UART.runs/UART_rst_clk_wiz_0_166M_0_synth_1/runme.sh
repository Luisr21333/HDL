...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Arty A7-100T/UART/UART/UART.runs/UART_rst_clk_wiz_0_166M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_rst_clk_wiz_0_166M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_rst_clk_wiz_0_166M_0.tcl
