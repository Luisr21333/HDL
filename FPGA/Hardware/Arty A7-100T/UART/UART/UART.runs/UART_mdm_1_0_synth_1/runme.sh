...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Arty A7-100T/UART/UART/UART.runs/UART_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_mdm_1_0.tcl
