...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Arty A7-100T/VHDL/counting_led/counting_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counting_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counting_led.tcl
