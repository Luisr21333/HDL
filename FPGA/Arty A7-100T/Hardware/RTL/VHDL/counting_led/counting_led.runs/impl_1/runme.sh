...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Arty A7-100T/VHDL/counting_led/counting_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counting_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counting_led.tcl -notrace
