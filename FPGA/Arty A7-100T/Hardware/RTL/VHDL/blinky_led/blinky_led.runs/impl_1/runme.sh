...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Arty A7-100T/VHDL/blinky_led/blinky_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinky_led.tcl -notrace
