...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Arty A7-100T/VHDL/blinky_led/blinky_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinky_led.tcl
