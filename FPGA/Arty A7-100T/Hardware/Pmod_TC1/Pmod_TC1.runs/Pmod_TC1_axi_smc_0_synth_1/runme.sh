...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Arty A7-100T/Pmod_TC1/Pmod_TC1.runs/Pmod_TC1_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_TC1_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pmod_TC1_axi_smc_0.tcl
