...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Arty A7-100T/Pmod_OLED/Pmod_OLED.runs/Pmod_OLED_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_OLED_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pmod_OLED_ilmb_bram_if_cntlr_0.tcl
