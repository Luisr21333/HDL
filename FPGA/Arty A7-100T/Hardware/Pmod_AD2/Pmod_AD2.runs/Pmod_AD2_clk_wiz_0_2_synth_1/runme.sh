...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Arty A7-100T/Pmod_AD2/Pmod_AD2.runs/Pmod_AD2_clk_wiz_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_AD2_clk_wiz_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pmod_AD2_clk_wiz_0_2.tcl
