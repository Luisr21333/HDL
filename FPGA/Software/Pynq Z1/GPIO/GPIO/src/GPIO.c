...
int button;
print("Push buttons only control first RGB LED\n\r");
	...
	while (1) {
		...
		case 1:
			...
			XGpio_DiscreteWrite(&gpio, 1, DARK_BLUE); // Write to output channel 1 (RGB LEDs)
			print("\tDARK BLUE\n\r");
			break;
		case 2:
			xil_printf("Input combination %d :",button);
			XGpio_DiscreteWrite(&gpio, 1, GREEN); // Write to output channel 1 (RGB LEDs)
			print("\tGREEN\n\r");
			break;
		case 3:
			xil_printf("Input combination %d :",button);
			XGpio_DiscreteWrite(&gpio, 1, LIGHT_BLUE); // Write to output channel 1 (RGB LEDs)
			print("\tLIGHT BLUE\n\r");
			sleep(1);
			break;
		case 4:
			xil_printf("Input combination %d :",button);
			XGpio_DiscreteWrite(&gpio, 1, RED); // Write to output channel 1 (RGB LEDs)
			print("\tRED\n\r");
			break;
		case 5:
			xil_printf("Input combination %d :",button);
			XGpio_DiscreteWrite(&gpio, 1, PURPLE); // Write to output channel 1 (RGB LEDs)
			print("\tPURPLE\n\r");
			sleep(1);
			break;
		case 6:
			xil_printf("Input combination %d :",button);
			XGpio_DiscreteWrite(&gpio, 1, YELLOW); // Write to output channel 1 (RGB LEDs)
			print("\tYELLOW\n\r");
			sleep(1);
			break;
		case 8:
			xil_printf("Input combination %d :", button);
			print("\tWHITE\n\r");
			XGpio_DiscreteWrite(&gpio, 1, WHITE); // Write to output channel 1 (RGB LEDs)
			sleep(1);
			break;

		default:
			// Keep RGB LEDs off when no push button is pressed
