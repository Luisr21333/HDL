...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Pynq Z1/Sensors/Sensors.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensors_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sensors_wrapper.tcl
