...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Pynq Z1/Sensors/Sensors.runs/Sensors_auto_pc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensors_auto_pc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sensors_auto_pc_2.tcl
