...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Pynq Z1/Sensors/Sensors.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensors_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sensors_wrapper.tcl -notrace
