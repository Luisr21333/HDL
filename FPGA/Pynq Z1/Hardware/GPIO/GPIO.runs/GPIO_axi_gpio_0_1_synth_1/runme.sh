...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Pynq Z1/GPIO/GPIO/GPIO.runs/GPIO_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPIO_axi_gpio_0_1.tcl
