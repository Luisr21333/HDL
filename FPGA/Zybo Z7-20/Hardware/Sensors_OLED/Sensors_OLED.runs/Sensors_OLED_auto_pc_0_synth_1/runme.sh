...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Zybo Z7-20/Sensors_OLED/Sensors_OLED.runs/Sensors_OLED_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensors_OLED_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sensors_OLED_auto_pc_0.tcl
