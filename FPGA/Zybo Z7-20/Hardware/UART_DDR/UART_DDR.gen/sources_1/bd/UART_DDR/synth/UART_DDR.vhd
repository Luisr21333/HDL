...
entity UART_DDR is
  ...
  attribute CORE_GENERATION_INFO of UART_DDR : entity is "UART_DDR,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=UART_DDR,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of UART_DDR : entity is "UART_DDR.hwdef";
end UART_DDR;

architecture STRUCTURE of UART_DDR is
  component UART_DDR_processing_system7_0_0 is
  port (
  ...
  end component UART_DDR_processing_system7_0_0;
...
begin
processing_system7_0: component UART_DDR_processing_system7_0_0
     port map (
