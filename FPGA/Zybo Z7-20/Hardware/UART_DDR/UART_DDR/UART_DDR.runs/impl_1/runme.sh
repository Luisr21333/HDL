...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Arty A7-100T/UART_DDR/UART_DDR/UART_DDR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_DDR_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_DDR_wrapper.tcl -notrace
