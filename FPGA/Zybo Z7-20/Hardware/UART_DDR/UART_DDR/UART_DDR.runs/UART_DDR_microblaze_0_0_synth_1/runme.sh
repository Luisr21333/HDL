...
HD_PWD='C:/Users/luisr/Desktop/FPGA/Hardware/Arty A7-100T/UART_DDR/UART_DDR/UART_DDR.runs/UART_DDR_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_DDR_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_DDR_microblaze_0_0.tcl
