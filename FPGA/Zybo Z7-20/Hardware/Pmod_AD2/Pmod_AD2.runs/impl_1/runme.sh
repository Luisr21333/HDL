...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Pmod_AD2/Pmod_AD2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pmod_AD2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pmod_AD2_wrapper.tcl -notrace
