...
HD_PWD='C:/Users/lurivera/Desktop/KCU105/GPIO/GPIO.runs/GPIO_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPIO_dlmb_bram_if_cntlr_0.tcl
