...
module GPIO
   (ddr4_sdram_DR_act_n,
    ...
    rs232_uart_rxd,
    rs232_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR ACT_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME ddr4_sdram_DR, AXI_ARBITRATION_SCHEME RD_PRI_REG, BURST_LENGTH 8, CAN_DEBUG false, CAS_LATENCY 17, CAS_WRITE_LATENCY 12, CS_ENABLED true, CUSTOM_PARTS no_file_loaded, DATA_MASK_ENABLED DM_NO_DBI, DATA_WIDTH 64, MEMORY_PART EDY4016AABG-DR-F, MEMORY_TYPE Components, MEM_ADDR_MAP ROW_COLUMN_BANK, SLOT Single, TIMEPERIOD_PS 833" *) output ddr4_sdram_DR_act_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR ADR" *) output [16:0]ddr4_sdram_DR_adr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR BA" *) output [1:0]ddr4_sdram_DR_ba;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR BG" *) output ddr4_sdram_DR_bg;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR CK_C" *) output ddr4_sdram_DR_ck_c;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR CK_T" *) output ddr4_sdram_DR_ck_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR CKE" *) output ddr4_sdram_DR_cke;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR CS_N" *) output ddr4_sdram_DR_cs_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR DM_N" *) inout [7:0]ddr4_sdram_DR_dm_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR DQ" *) inout [63:0]ddr4_sdram_DR_dq;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR DQS_C" *) inout [7:0]ddr4_sdram_DR_dqs_c;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR DQS_T" *) inout [7:0]ddr4_sdram_DR_dqs_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR ODT" *) output ddr4_sdram_DR_odt;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 ddr4_sdram_DR RESET_N" *) output ddr4_sdram_DR_reset_n;
  ...
  wire reset_1;
  wire [0:0]rst_ddr4_0_300M_bus_struct_reset;
  wire rst_ddr4_0_300M_mb_reset;
  ...
  assign ddr4_sdram_DR_act_n = ddr4_0_C0_DDR4_ACT_N;
  assign ddr4_sdram_DR_adr[16:0] = ddr4_0_C0_DDR4_ADR;
  assign ddr4_sdram_DR_ba[1:0] = ddr4_0_C0_DDR4_BA;
  assign ddr4_sdram_DR_bg = ddr4_0_C0_DDR4_BG;
  assign ddr4_sdram_DR_ck_c = ddr4_0_C0_DDR4_CK_C;
  assign ddr4_sdram_DR_ck_t = ddr4_0_C0_DDR4_CK_T;
  assign ddr4_sdram_DR_cke = ddr4_0_C0_DDR4_CKE;
  assign ddr4_sdram_DR_cs_n = ddr4_0_C0_DDR4_CS_N;
  assign ddr4_sdram_DR_odt = ddr4_0_C0_DDR4_ODT;
  assign ddr4_sdram_DR_reset_n = ddr4_0_C0_DDR4_RESET_N;
  ...
  GPIO_axi_uartlite_0_0 axi_uartlite_0
  ...
  GPIO_ddr4_0_0 ddr4_0
       (.c0_ddr4_act_n(ddr4_0_C0_DDR4_ACT_N),
        ...
        .c0_ddr4_dm_dbi_n(ddr4_sdram_DR_dm_n[7:0]),
        .c0_ddr4_dq(ddr4_sdram_DR_dq[63:0]),
        .c0_ddr4_dqs_c(ddr4_sdram_DR_dqs_c[7:0]),
        .c0_ddr4_dqs_t(ddr4_sdram_DR_dqs_t[7:0]),
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > GPIO microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  GPIO_microblaze_0_0 microblaze_0
       (.Byte_Enable(microblaze_0_dlmb_1_BE),
        ...
        .Reset(rst_ddr4_0_300M_mb_reset),
        .Write_Strobe(microblaze_0_dlmb_1_WRITESTROBE));
  GPIO_microblaze_0_axi_periph_0 microblaze_0_axi_periph
       (.ACLK(microblaze_0_Clk),
        .ARESETN(rst_ddr4_0_300M_peripheral_aresetn),
  ...
  microblaze_0_local_memory_imp_1762SX7 microblaze_0_local_memory
       (.DLMB_abus(microblaze_0_dlmb_1_ABUS),
        ...
        .SYS_Rst(rst_ddr4_0_300M_bus_struct_reset));
  GPIO_rst_ddr4_0_300M_0 rst_ddr4_0_300M
       (.aux_reset_in(1'b1),
        .bus_struct_reset(rst_ddr4_0_300M_bus_struct_reset),
        .dcm_locked(1'b1),
        .ext_reset_in(ddr4_0_c0_ddr4_ui_clk_sync_rst),
        .mb_debug_sys_rst(mdm_1_debug_sys_rst),
        .mb_reset(rst_ddr4_0_300M_mb_reset),
        .peripheral_aresetn(rst_ddr4_0_300M_peripheral_aresetn),
        .slowest_sync_clk(microblaze_0_Clk));
endmodule

module GPIO_microblaze_0_axi_periph_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_FQWQA7 m00_couplers
  ...
  m01_couplers_imp_1A07989 m01_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  s00_couplers_imp_1YL23I2 s00_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module m00_couplers_imp_FQWQA7
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m01_couplers_imp_1A07989
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_1762SX7
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > GPIO microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  GPIO_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  GPIO_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  GPIO_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
...
module s00_couplers_imp_1YL23I2
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
